...
function addBorder(type, color) {
    if (document.querySelector("#SFoAProductionWarningLeftBar") != null) {
        var leftBarObj = document.querySelector("#SFoAProductionWarningLeftBar");
        leftBarObj.parentNode.removeChild(leftBarObj);
        var rightBarObj = document.querySelector("#SFoAProductionWarningRightBar");
        rightBarObj.parentNode.removeChild(rightBarObj);
        var topBarObj = document.querySelector("#SFoAProductionWarningTopBar");
        topBarObj.parentNode.removeChild(topBarObj);
        var buttomBarObj = document.querySelector("#SFoAProductionWarningButtomBar");
    ...
    addBar("SFoAProductionWarningLeftBar", args + ";width: 0px;height:" + height + "px;top:0px;left:0px;");
    addBar("SFoAProductionWarningTopBar", args + ";width:" + width + "px;height:0px;top:0px;left:5px;");
    addBar("SFoAProductionWarningRightBar", args + ";width: 0px;height:" + height + "px;top:5px;left:" + width + "px;");
    addBar("SFoAProductionWarningButtomBar", args + ";width:" + width + "px;height:0px;top:" + height + "px;left:0px;");
}

function addOverlay(color) {
    const id = 'SFoAProductionWarningOverlay';
...
function isSalesforce(s) {
    var regu = /^(.*\.lightning\.sfcrmapps\.cn|.*[\.my]?\.(sfcrmproducts|vf\.sfcrmapps)\.cn)$/g;
    var re = new RegExp(regu);
    if (re.test(s)) {
        return true;
    } else {
